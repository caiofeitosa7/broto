        ...
        methods: {
            async validarUsuario() {
                ...
                if (!dados.nome || !dados.cpf)
                    ...
                    this.erro = 'Digite somente os números do CPF';
                else {
                    try {
            ...
            recuperarSenha() {
                let senhaValida = this.validarSenha();
...
<template>
    <div class="container-recuperacao">
        ...
        <form v-if="bloco_senha" @submit.prevent="recuperarSenha">
            <div class="is-flex is-justify-content-center">
                <a class="logo" href="/">
                    <img class="image" src="@/assets/images/broto-1.3.png" alt="Logo do Broto" width="50px" height="50px"/>
                </a>
            </div>
            <p v-if="!senhaAlterada" class="has-text-weight-medium has-text-centered is-size-7 mt-2 mb-5">
            ...
            <div class="field control pt-3">
                <button v-if="!senhaAlterada" class="button is-primary is-fullwidth" type="submit">
                    Enviar
                </button>
                <a v-if="senhaAlterada" href="/login">
